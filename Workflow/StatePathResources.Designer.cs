...
namespace Grammophone.Domos.Domain.Workflow {
    ...
    public class StatePathResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Identifier of the state path, to be referred by the system..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Optional description of the state path..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to The name of the state path..
        /// </summary>
